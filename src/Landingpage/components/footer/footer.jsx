        ...
        <div className="Footer_mobile" style={{background:"#034c81",maxWidth:"1920px"}}>
            ...
            <div className="bottom_footer" style={{background:"#ededed"}}>
                ...
                <div className="footer_terms" style={{display:"flex",justifyContent:"spaceEvenly"}}>
                    <div className="allright"><span style={{color:"#034c81",fontWeight:"normal"}}> Dr Hero © 2023 | All Rights Reserved</span></div>
                    <div><span style={{color:"#e04d63",fontWeight:"normal"}}> <span className="development" style={{color:"#034c81"}}>Development |</span>&nbsp;<a href="https://hashgate.ae" target="blank" style={{textDecoration:"none",color:"#e04d62"}}>Hash Gate Technology</a></span></div>
                    <div  style={{display:"flex",color:"#034c81",fontWeight:"normal"}}>
                        <a href="./privacy" style={{textDecoration:"none",color:"#034c81"}}><div className="privacy">Privacy Policy <span style={{color:"#034c81",fontWeight:"bold"}}>|</span></div></a>
                        <a href="./terms" style={{textDecoration:"none",color:"#034c81"}}><div className="terms"> &nbsp;Terms Of Use</div></a>
                    </div>
                </div>
